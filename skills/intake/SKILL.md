...
- **Fact thì tra code, không hỏi** (đọc code hiện có, file cấu hình, `docs/` / README của project). Chỉ hỏi
...
Thiết kế PO gửi (thư mục design-ref của project, link Figma, hoặc file PO đưa) là **source of truth cho UI**. Map từng
